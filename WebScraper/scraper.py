...
def get_laptop_data():
    ...
    for laptop_div in laptop_divs:
        ...
        # Define the js_code variable with your JavaScript code
        js_code = f"""
        <script>
            // JavaScript code specific to this laptop
            // For example, you can add a button click event
            document.addEventListener('DOMContentLoaded', function() {{
                var button = document.querySelector('#{laptop_name}-button');
                if (button) {{
                    button.addEventListener('click', function() {{
                        alert('You clicked the button for {laptop_name}!');
                    }});
                }}
            }});
        </script>
        ...
        laptops_data.append({
            ...
            'savings': savings,
            'js_code': js_code  # Include the JavaScript code for this laptop
        })
